...
3. Register a matching `@mcp.tool()` in `src/vertiguard_mcp/server.py`, with `ToolAnnotations` that accurately describe whether it's read-only / destructive / idempotent.
